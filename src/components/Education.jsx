    ...
    >
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-300 mt-4 text-lg font-semibold">
          A glimpse into my academic journey and the achievements that have shaped my development.
        </p>
      </div>
      ...
      <div className="relative">
        ...
        {education.map((edu, index) => (
          ...
          >
            {/* Timeline Circle */}
            <div className="absolute sm:left-1/2 left-0 transform -translate-x-1/2 bg-gray-400 border-4 border-[#21a7eb] w-12 h-12 sm:w-16 sm:h-16 rounded-full flex justify-center items-center z-10">
              <img
                src={edu.img}
                alt={edu.school}
            ...
            <div
              className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl border border-white/20 bg-[#043a53]/70 backdrop-blur-md shadow-[0_0_20px_1px_rgba(33,167,235,0.4)] ${index % 2 === 0 ? "sm:ml-0" : "sm:mr-0"
                } ml-10 lg:m-0 md:ml-32 md:mr-32 transform transition-transform duration-300 hover:scale-105`}
            >
